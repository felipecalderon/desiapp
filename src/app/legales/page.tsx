                ...
                <div className="flex flex-col justify-start items-center w-1/3 mt-10 space-y-4">
                    <div className="bg-white rounded-lg p-4 w-full shadow-md">
                        ...
                        <p className="text-sm text-gray-600">
                            Ubicación General: <span className="font-bold">{store.location}</span>
                        </p>
                        <p className="text-sm text-gray-600">
                            Dirección:{' '}
                        ...
                        <p className="text-sm text-gray-600">
                            RUT: <span className="font-bold">{store.rut}</span>
                        </p>
                        <p className="text-sm text-gray-600">
                            Teléfono: <span className="font-bold">{store.phone}</span>
                        </p>
                    </div>
                    <button
                        id="contrato"
                        onClick={clickButton}
                        className="py-3 text-white bg-blue-700 w-52 rounded-xl hover:shadow-md transition-all"
                    >
                        Contrato
                    </button>
                    <button
                        ...
                        {user && user.role === Role.Admin && buttonId !== '' && (
                            <>
                                ...
                                <p className="py-2 italic">
                                    Cargar <span className="font-bold">{buttonId}</span>:
                                </p>
