...
export default function DetalleOrden({ params }: { params: { ordenID: string } }) {
    ...
    const handleInputChange = (e: ChangeEvent<HTMLInputElement>, variation: Variacion) => {
        ...
        const newCantidades = {
            ...cantidades,
            [variation.variationID]: newCantidad,
        }
    ...
    return (
        <div ref={tablaRef} className="mx-auto my-1 px-4">
            ...
            <div className="flex flex-row gap-3 mt-3">
                <CardDataSale icon={FaShop} title="Tienda asociada">
                    ...
                    <div className="flex flex-row justify-between my-3 gap-3">
                        ...
                        <Input
                            onChange={(e) =>
                                setEditOrder({
                                    ...editOrder,
                                    startQuote: Number(e.target.value),
                                })
                            }
                            type="number"
                            min={0}
                        ...
                        <Input
                            onChange={(e) =>
                                setEditOrder({
                                    ...editOrder,
                                    endQuote: Number(e.target.value),
                                })
                            }
                            type="number"
                            min={1}
