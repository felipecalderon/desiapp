...
const ResumeCompra = () => {
    ...
    if (productos.length > 0)
        return (
            <footer className="fixed bottom-0 left-60 hover:scale-105 hover:shadow-xl transition-all shadow-blue-400 bg-green-500 text-gray-800 rounded-t-lg p-3">
                <div className="flex items-center px-6 justify-between">
                    ...
                    <div className="pl-6 pr-3 cursor-pointer">
                        <span className="text-white text-4xl hover:text-6xl transition-all">
